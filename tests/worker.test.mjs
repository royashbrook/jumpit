...
const REQUIRED_SHELL = [
  './', './index.html', './app.css?v=10', './app.js?v=10', './audio.js', './daily.js',
  './game.js?v=8', './levels.js', './release.js', './save.js', './engine/physics.js',
...
test('activation migrates v1.5 clients in scope after the complete B cache wins', async () => {
  const activation = activateWith(
    ['jumpit-v1.5.0', 'jumpit-v1.9.0', 'jumpit-v2.0.0', 'jumpit-v2.0.0-r2', 'jumpit-v2.0.0-r3', 'jumpit-v2.0.0-r4', 'jumpit-v2.0.0-r5', 'jumpit-v2.0.0-r6', 'jumpit-v2.0.0-r7', 'jumpit-v2.0.0-r8', 'jumpit-v2.0.0-r9', 'jumpit-v2.0.0-r10', 'jumpit-v2.0.0-r11', 'jumpit-v2.0.0-r12', 'sibling-game-v4'],
    [
  ...
  assert.deepEqual(activation.deleted, ['jumpit-v1.5.0', 'jumpit-v1.9.0', 'jumpit-v2.0.0', 'jumpit-v2.0.0-r2', 'jumpit-v2.0.0-r3', 'jumpit-v2.0.0-r4', 'jumpit-v2.0.0-r5', 'jumpit-v2.0.0-r6', 'jumpit-v2.0.0-r7', 'jumpit-v2.0.0-r8', 'jumpit-v2.0.0-r9', 'jumpit-v2.0.0-r10', 'jumpit-v2.0.0-r11'])
...
test('activation without the v1.5 cache claims but never forces a navigation', async () => {
  const activation = activateWith(['jumpit-v1.8.0', 'jumpit-v1.9.0', 'jumpit-v2.0.0', 'jumpit-v2.0.0-r2', 'jumpit-v2.0.0-r3', 'jumpit-v2.0.0-r4', 'jumpit-v2.0.0-r5', 'jumpit-v2.0.0-r6', 'jumpit-v2.0.0-r7', 'jumpit-v2.0.0-r8', 'jumpit-v2.0.0-r9', 'jumpit-v2.0.0-r10', 'jumpit-v2.0.0-r11', 'jumpit-v2.0.0-r12'], [
    'https://example.test/jumpit/',
  ])
  await activation.done
  assert.deepEqual(activation.deleted, ['jumpit-v1.8.0', 'jumpit-v1.9.0', 'jumpit-v2.0.0', 'jumpit-v2.0.0-r2', 'jumpit-v2.0.0-r3', 'jumpit-v2.0.0-r4', 'jumpit-v2.0.0-r5', 'jumpit-v2.0.0-r6', 'jumpit-v2.0.0-r7', 'jumpit-v2.0.0-r8', 'jumpit-v2.0.0-r9', 'jumpit-v2.0.0-r10', 'jumpit-v2.0.0-r11'])
  assert.equal(activation.claims(), 1)
