...
export const LEVELS = [
  ...
  level('keep-1', 17, 'keep', 'Gatehouse Glow', 70, [2, 14], ['k01-bell', 67, 14], ['stone-sentries'], [
    ['k01-a', 'stone', 0, 15, 12, 3], ['k01-b', 'stone', 15, 15, 10, 3],
    ['k01-c', 'stone', 28, 15, 9, 3], ['k01-d', 'stone', 40, 15, 12, 3],
    ['k01-e', 'stone', 55, 15, 15, 3], ['k01-f', 'beacon', 9, 12, 6, 1],
    ['k01-g', 'stone', 23, 12, 6, 1], ['k01-h', 'beacon', 35, 12, 6, 1],
    ['k01-i', 'stone', 50, 12, 6, 1],
  ], [
    ['k01-seed-a', 'seed', 11, 11], ['k01-seed-b', 'seed', 26, 11],
    ['k01-seed-c', 'seed', 38, 11], ['k01-seed-d', 'seed', 53, 11],
    ['k01-check', 'checkpoint', 44, 14], ['k01-sentry-a', 'sentry', 20, 14],
    ['k01-sentry-b', 'sentry', 59, 14],
  ]),

  level('keep-2', 18, 'keep', 'Bellrope Gallery', 76, [2, 14], ['k02-bell', 73, 14], ['keep-lifts'], [
    ['k02-a', 'stone', 0, 15, 10, 3], ['k02-b', 'stone', 13, 15, 9, 3],
    ['k02-c', 'stone', 25, 15, 10, 3], ['k02-d', 'stone', 38, 15, 8, 3],
    ['k02-e', 'stone', 49, 15, 10, 3], ['k02-f', 'stone', 62, 15, 14, 3],
    ['k02-g', 'lift', 8, 12, 6, 1], ['k02-h', 'beacon', 20, 12, 7, 1],
    ['k02-i', 'lift', 33, 12, 7, 1], ['k02-j', 'beacon', 44, 12, 7, 1],
    ['k02-k', 'lift', 57, 12, 7, 1],
  ], [
    ['k02-seed-a', 'seed', 10, 11], ['k02-seed-b', 'seed', 23, 11],
    ['k02-seed-c', 'seed', 36, 11], ['k02-seed-d', 'seed', 47, 11],
    ['k02-seed-e', 'seed', 60, 11], ['k02-check', 'checkpoint', 43, 14],
    ['k02-sentry-a', 'sentry', 17, 14], ['k02-sentry-b', 'sentry', 54, 14],
  ]),

  level('keep-3', 19, 'keep', 'Windward Tower', 82, [2, 14], ['k03-bell', 79, 14], ['tower-gusts'], [
    ['k03-a', 'stone', 0, 15, 11, 3], ['k03-b', 'crumble', 14, 15, 8, 3],
    ['k03-c', 'stone', 25, 15, 9, 3], ['k03-d', 'crumble', 37, 15, 8, 3],
    ['k03-e', 'stone', 48, 15, 10, 3], ['k03-f', 'crumble', 61, 15, 8, 3],
    ['k03-g', 'stone', 72, 15, 10, 3], ['k03-h', 'lift', 9, 12, 6, 1],
    ['k03-i', 'beacon', 20, 12, 7, 1], ['k03-j', 'lift', 32, 12, 7, 1],
    ['k03-k', 'beacon', 43, 12, 7, 1], ['k03-l', 'lift', 56, 12, 7, 1],
    ['k03-m', 'beacon', 67, 12, 7, 1],
  ], [
    ['k03-seed-a', 'seed', 11, 11], ['k03-seed-b', 'seed', 23, 11],
    ['k03-seed-c', 'seed', 35, 11], ['k03-seed-d', 'seed', 46, 11],
    ['k03-seed-e', 'seed', 59, 11], ['k03-seed-f', 'seed', 70, 11],
    ['k03-check', 'checkpoint', 51, 14], ['k03-sentry-a', 'sentry', 18, 14],
    ['k03-sentry-b', 'sentry', 65, 14], ['k03-fan-a', 'fan', 29, 14],
    ['k03-fan-b', 'fan', 75, 14],
  ]),

  level('keep-4', 20, 'keep', 'The Waking Beacon', 88, [2, 14], ['k04-bell', 85, 14], ['beacon-guardian'], [
    ['k04-a', 'stone', 0, 15, 12, 3], ['k04-b', 'stone', 15, 15, 8, 3],
    ['k04-c', 'crumble', 26, 15, 9, 3], ['k04-d', 'stone', 38, 15, 8, 3],
    ['k04-e', 'crumble', 49, 15, 9, 3], ['k04-f', 'stone', 61, 15, 8, 3],
    ['k04-g', 'stone', 72, 15, 16, 3], ['k04-h', 'beacon', 10, 12, 6, 1],
    ['k04-i', 'lift', 21, 12, 7, 1], ['k04-j', 'beacon', 33, 12, 7, 1],
    ['k04-k', 'lift', 44, 12, 7, 1], ['k04-l', 'beacon', 56, 12, 7, 1],
    ['k04-m', 'lift', 67, 12, 7, 1], ['k04-n', 'beacon', 78, 12, 7, 1],
  ], [
    ['k04-seed-a', 'seed', 12, 11], ['k04-seed-b', 'seed', 24, 11],
    ['k04-seed-c', 'seed', 36, 11], ['k04-seed-d', 'seed', 47, 11],
    ['k04-seed-e', 'seed', 59, 11], ['k04-seed-f', 'seed', 70, 11],
    ['k04-seed-g', 'seed', 81, 11], ['k04-check', 'checkpoint', 53, 14],
    ['k04-sentry-a', 'sentry', 18, 14], ['k04-sentry-b', 'sentry', 65, 14],
    ['k04-warden', 'warden', 78, 14], ['k04-fan', 'fan', 41, 14],
    ['k04-lamp', 'lamp', 74, 14],
  ]),
]
